...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tobac-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7314&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tobac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tobac` can be installed with:

```
conda install tobac
```

It is possible to list all of the versions of `tobac` available on your platform with:
